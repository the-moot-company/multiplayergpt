...
export const ChatInput = ({
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full border-transparent bg-gradient-to-b from-transparent via-white to-white pt-6 md:pt-2">
      <div className="stretch mx-2 mt-2 flex flex-row gap-0 last:mb-2 md:mx-4 md:mt-[52px] md:last:mb-6 lg:mx-auto lg:max-w-3xl">
        {messageIsStreaming && (
          <button
        ...
        <div className="relative mx-2 flex w-full flex-grow flex-col rounded-lg border border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)] sm:mx-0 min-h-10 md:pt-0">
          ...
          <button
            className="absolute right-2 top-1 md:top-2 rounded-sm p-1 text-neutral-800 opacity-60 hover:bg-neutral-200 hover:text-neutral-900 dark:bg-opacity-50 dark:text-neutral-100 dark:hover:text-neutral-200"
            onClick={handleSend}
          >
            {messageIsStreaming ? (
      ...
      <div className="px-3 pt-2 pb-3 text-center text-[12px] text-black/50 dark:text-white/50 md:px-4 md:pt-3 md:pb-4">
        ...
        .{' '}
        {t(
          'MultiplayerGPT is a multiplayer GPT chatbot built by Moot, independently from ChatGPT or OpenAI.',
        )}
      </div>
    </div>
  );
